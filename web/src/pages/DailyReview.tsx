...
const DailyReview = () => {
  ...
  return (
    <section className="w-full max-w-2xl min-h-full flex flex-col justify-start sm:justify-center items-center px-4 sm:px-2 sm:pt-4 pb-8 bg-zinc-100 dark:bg-zinc-800">
      <MobileHeader showSearch={false} />
      <div className="w-full flex flex-col h-4/5 overflow-y-scroll justify-start items-start px-4 py-3 rounded-xl bg-white dark:bg-zinc-700 text-black dark:text-gray-300">
