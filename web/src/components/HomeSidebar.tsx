...
const HomeSidebar = () => {
  ...
  return (
    <div
      className={`fixed flex flex-col justify-center md:sticky top-0 left-0 w-full md:w-56 h-full shrink-0 pointer-events-none md:pointer-events-auto z-10 ${
